...
<a href="../../login.jsp" style="position: absolute;left: 730px;top:50px;"><button style="font-size: 15px;color: red;background-color: yellow">注销</button></a>
    ...
    <div class="messageright">
        <div class="formpage">
            ...
            <form action="/file-upload" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="docLabel" id="docLabel" value="jotting">
