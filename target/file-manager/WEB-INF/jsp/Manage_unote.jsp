...
<a href="../../login.jsp" style="position: absolute;left: 730px;top:50px;">
    <button class="logout">注销</button></a>
<div class="messagebox">
    ...
    <div class="messageright">
        <div class="formpage">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <button id="searchbutton" onclick="findIt();"><img src="../../img/search_icon.png"></button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

            <form action="/file-upload" method="post" enctype="multipart/form-data">
                <input type="file" name="file" id="file"/>
                <input type="hidden" name="docLabel" id="docLabel" value="note">
